 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --no-compress --stride 1 --align 1 --font DejaVuSans.ttf --symbols ÄÖÜäöüß --range 32-126 --format lvgl -o lv_font_dejavu_16_german.c
 ******************************************************************************/
...
#ifndef LV_FONT_DEJAVU_16_GERMAN
#define LV_FONT_DEJAVU_16_GERMAN 1
#endif

#if LV_FONT_DEJAVU_16_GERMAN
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc_16[] = {
    ...
    {.bitmap_index = 4336, .adv_w = 175, .box_w = 11, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4419, .adv_w = 202, .box_w = 12, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4509, .adv_w = 187, .box_w = 10, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4584, .adv_w = 161, .box_w = 9, .box_h = 12, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4638, .adv_w = 157, .box_w = 9, .box_h = 12, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4692, .adv_w = 157, .box_w = 9, .box_h = 12, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4746, .adv_w = 162, .box_w = 8, .box_h = 12, .ofs_x = 1, .ofs_y = 0}
};
...
static const uint16_t unicode_list_1_16[] = {
...
static const lv_font_fmt_txt_cmap_t cmaps_16[] =
{
    ...
    },
    {
        ...
        .unicode_list = unicode_list_1_16, .glyph_id_ofs_list = NULL, .list_length = 7, .type = LV_FONT_FMT_TXT_CMAP_SPARSE_TINY
    }
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_dejavu_16_german = {
#else
lv_font_t lv_font_dejavu_16_german = {
#endif
...
#endif /*#if LV_FONT_DEJAVU_16_GERMAN*/
